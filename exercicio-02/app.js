...
const myFavoriteTom = "O tom que eu mais gosto é :" + tom + " " + firstTom
...
const loweCase = summerMessage.toLowerCase()
...
const upperCase = winterMessage.toUpperCase()
...
const sliceHarryAuthor = harryPotterAuthor.slice(0, 4)

// console.log(sliceHarryAuthor)
...
*/
const allEpisodes = `"O numero de episódios" ${episodes}`
